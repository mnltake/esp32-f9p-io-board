void calcSteeringPID(void) 
 {
  ...
  //Proportional
  pValue = IOSettings.Kp * steerAngleError *IOSettings.Ko;  

 /* //Derivative
  dError = steerAngleError - lastLastError;
  dValue = IOSettings.Kd * (dError) * IOSettings.Ko;
 ...
 */
  ...
  if (pwmDrive < 0 ) pwmDrive -= IOSettings.minPWMValue;
  else if (pwmDrive > 0 ) pwmDrive += IOSettings.minPWMValue;
